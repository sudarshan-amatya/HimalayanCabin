...
async function refreshCabinRating(cabinId: string) {
...
export async function getMyCabinReview(
  req: Request<{ cabinId: string }>,
  res: Response,
) {
  try {
...
export async function upsertCabinReview(
  req: Request<{ cabinId: string }>,
  res: Response,
) {
  try {
...
export async function deleteMyCabinReview(
  req: Request<{ cabinId: string }>,
  res: Response,
) {
  try {
