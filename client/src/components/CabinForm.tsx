      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <div className="md:col-span-2">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <input name="image" value={formData.image} onChange={handleChange} placeholder="Main image URL" className="rounded-md border border-gray-300 px-4 py-3 text-sm outline-none focus:border-[#24472f]" />
